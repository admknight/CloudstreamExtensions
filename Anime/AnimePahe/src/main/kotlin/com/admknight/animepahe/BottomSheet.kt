...
class BottomFragment(private val plugin: AnimePaheProviderPlugin) : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(
        ...
        val packageName = "com.admknight.animepahe"
        val id = plugin.resources!!.getIdentifier("bottom_sheet_layout", "layout", packageName)
        val layout = plugin.resources!!.getLayout(id)
        val view = inflater.inflate(layout, container, false)

        val outlineId = plugin.resources!!.getIdentifier("outline", "drawable", packageName)
        val saveIconId = plugin.resources!!.getIdentifier("save_icon", "drawable", packageName)
        ...
        val radioBtnId = plugin.resources!!.getIdentifier("radio_button", "layout", packageName)
    ...
    private fun <T : View> View.findView(name: String): T {
        val id = plugin.resources!!.getIdentifier(name, "id", "com.admknight.animepahe")
