...
1.  **Settings** -> **Extensions** -> **Add Repository**
2.  URL: `https://raw.githubusercontent.com/admknight/CloudstreamExtensions/builds/plugins.json`
...
*   **Categorized**: Plugins are split into `Anime`, `Bollywood`, `International`, `LiveTV`, and `Tools`.
*   **Branded**: Every plugin is re-authored to "Adam Knight" for consistency.
*   **Reliable**: Icons are mirrored locally to prevent broken images in-app.
*   **Up-to-date**: Syncs daily from Hexated, Phisher, Megix, and Storm sources.
